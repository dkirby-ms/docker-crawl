...
games = OrderedDict([
    ...
    ("dcss-web-0.27", dict(
        ...
        crawl_binary = "/app/bin/crawl",
        pre_options = [ "0.27" ],
        rcfile_path = rcfiles_dir + "/0.27",
        macro_path = rcfiles_dir + "/0.27", # using same path as rcfiles for simplicity
        morgue_path = morgue_dir,
        inprogress_path = inprogress_dir + "/0.27",
        ttyrec_path = ttyrec_dir + "/0.27" + "/%n/",
        socket_path = "/websockets",
        client_path = "/app/webserver/game_data",
        dir_path = dirpathroot_dir + "/0.27",
        # cwd = ".",
        # morgue_url = "http://crawl.kirbytoso.xyz/morgue/%n/",
        morgue_url = None,
        show_save_info = True,
